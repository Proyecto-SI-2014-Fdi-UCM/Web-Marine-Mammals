            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-10 col-md-5 col-xs-offset-1">
                  <input disabled title="a drug name is required" class="form-control" id="drug_name" type="text" value="<?php echo $drug_name;?>"> 
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-xs-10 col-md-9 col-xs-offset-1">
                  <textarea disabled type="text" maxlength="140" class="form-control" rows="2" id="description"><?php echo $description; ?></textarea>
                </div>
              </div>
                  ...
                  <?php 
                    if ($available == "Yes") { ?>
                      <div class="radio col-xs-2 col-xs-offset-1">                  
                        <input disabled type="radio" name="available" value="Yes" id="availableYes" checked = "checked"><label for="yes">Yes</label>  
                      </div>
                      <div class="radio col-xs-2">
                        <input disabled type="radio" name="available" id="availableNo"><label for="nd">Nd</label>
                      </div>
                  <?php }
                    else { ?>     
                      <div class="radio col-xs-2 col-xs-offset-1">                  
                        <input disabled type="radio" name="available" id="availableYes"><label for="yes">Yes</label>  
                      </div>
                      <div class="radio col-xs-2">
                        <input disabled type="radio" name="available" value="Nd" id="availableNo" checked = "checked"><label for="nd">Nd</label>
                      </div>  
                  <?php } ?>
                ...
                <div class="form-group">
                  ...
                  <div class="chk_ema checkbox col-xs-1 col-xs-offset-4">
                    <?php if ($license_EMA == "Yes") { ?>                      
                        <input disabled type="checkbox" value="Yes" id="chk_EMA" checked = "checked">                      
                    <?php } else { ?>      
                        <input disabled type="checkbox" value="Nd" id="chk_EMA">
                    <?php } ?>
                  </div>

                  <div class="checkbox col-xs-1 col-xs-offset-2">
                    <?php if ($license_FDA == "Yes") { ?>
                        <input disabled type="checkbox" value="Yes" id="chk_FDA" checked = "checked">
                     <?php } else { ?>      
                        <input disabled type="checkbox" value="Nd" id="chk_FDA">
                     <?php } ?>
                  </div>  

                  <div class="checkbox col-xs-1 col-xs-offset-2">
                    <?php if ($license_AEMPS == "Yes") { ?>
                      <input disabled type="checkbox" value="Yes" id="chk_AEMPS" checked = "checked">
                     <?php } else { ?>
                      <input disabled type="checkbox" value="Nd" id="chk_AEMPS">
                     <?php } ?>
                  </div>
          ...
          <div class="panel panel-default">
            <div class="panel-body">
              ...
              <div class="form-group">
                <div class="col-xs-8 col-md-7 required-label">
                  <div class="input-group">
                    <input disabled title="therapeutic target required" type="text" class="form-control" id="indexTherapeutic<?php echo $index ?>" type="text" value="<?php echo $therapeutic; ?>">                    
                    <span class="input-group-btn">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-3">
                  <div class="input-group">
                    <input disabled title="an ATCvet code is required" type="text" class="form-control" type="text" value="<?php echo $code; ?>"  id="indexCode<?php echo $index ?>">                    
                    <span class="input-group-btn">
          ...
          <div class="panel panel-default" id="nodeCode2">
            <div class="panel-body">
              ...
              <div class="form-group">                      
                <div class="col-xs-8 col-md-7 required-label">
                  <div class="input-group general">
                    <select disabled class="form-control" id="anatomic">
                      <option>Anatomic Target (1st level ATCvet)</option>
                      <option>QA Alimentary tract and metabolism</option>
                      <option>QB Blood and blood forming organs</option>
                      <option>QC Cardiovascular system</option>
              ...
              <div class="form-group">
                <div class="col-xs-8 col-md-7 required-label">
                  <div class="input-group">
                    <input disabled title="therapeutic target required" type="text" class="form-control" id="therapeutic" type="text" placeholder="Therapeutic Target (2nd level ATCvet)" required>
                    <span class="input-group-btn">
                      <a href="#therapeutic_window" class="btn btn-primary" data-toggle="modal">
                        <span class="glyphicon glyphicon-question-sign"></span>
                      </a>
              ...
              <div class="form-group">
                ...
                <div class="col-xs-3">
                  <div class="input-group">
                    <input disabled title="an ATCvet code is required" type="text" class="form-control" id="new_code" type="text" placeholder="Code" required>
                    <span class="input-group-btn">
                      <a href="#code_window" class="btn btn-primary" data-toggle="modal">
                        <span class="glyphicon glyphicon-question-sign"></span>
                      </a>
      ...
      <div class="panel panel-default">
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-10 col-md-5 col-xs-offset-1">
                  <input disabled title="a drug name is required" type="text" class="form-control" id="entry_drug_name" type="text" placeholder="Drug name (INN)" required> 
                </div>
              </div>
              ...
              <div class="form-group">
                <label for="available" class="col-xs-3 control-label">Available as generic drug</label>
                <div class="radio col-xs-2 col-xs-offset-1">
                   <input disabled type="radio" name="entry_description" id="Yes" value="Yes"><label for="yes">Yes</label>         
                </div>
                <div class="radio col-xs-2">
                  <input disabled type="radio" name="entry_description" id="Nd" value="Nd"><label for="nd">Nd</label>
                </div>
              </div>
              ...
              <div class="license">
                ...
                <div class="form-group">
                  <div class="chk_ema checkbox col-xs-1 col-xs-offset-4">
                    <input disabled type="checkbox" id="entry_chk_ema">
                  </div>
                  <div class="checkbox col-xs-1 col-xs-offset-2">
                    <input disabled type="checkbox" id="entry_chk_fda">
                  </div>              
                  <div class="checkbox col-xs-1 col-xs-offset-2">
                    <input disabled type="checkbox" id="entry_chk_aemps">
                  </div>
                </div>                 
              </div> 
          ...
          <div class="panel panel-default" id="nodeCode2">
            ...
            <div class="col-xs-12">
              ...
              <div class="form-group">
                <div class="col-xs-8 col-md-7 required-label">
                  <div class="input-group">
                    <input disabled title="therapeutic target required" type="text" class="form-control" id="entry_therapeutic_group" type="text" placeholder="Therapeutic Target (2nd level ATCvet)" required>
                    <span class="input-group-btn">
                      <a href="#therapeutic_window" class="btn btn-primary" data-toggle="modal">
                        <span class="glyphicon glyphicon-question-sign"></span>
                      </a>
              ...
              <div class="form-group">
                ...
                <div class="col-xs-3">
                  <div class="input-group">
                    <input disabled title="an ATCvet code is required" type="text" class="form-control" id="entry_code" type="text" placeholder="Code" required>
                    <span class="input-group-btn">
                      <a href="#code_window" class="btn btn-primary" data-toggle="modal">
                        <span class="glyphicon glyphicon-question-sign"></span>
                      </a>
