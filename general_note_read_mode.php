          ...
          <div class="row">
            <div class="col-xs-3">
			  ...
			  <?php if (isset($_GET['group'])) {
					if ((isset($_GET['option']) && !strcmp($_GET['option'], "Edit")) && isset($_GET['drug_name'])) { ?>
						<li class="current"><a href="./general_note_read_mode.php?option=Edit&&group=<?php echo $_GET['group']; ?>&&drug_name=<?php echo $_GET['drug_name']; ?>">General note</a></li>
					<?php } else { ?>
						<li class="current"><a href="./general_note_read_mode.php?group=<?php echo $_GET['group']; ?>">General note</a></li>
					<?php } 
					if ((isset($_GET['option']) && !strcmp($_GET['option'], "Edit")) && isset($_GET['drug_name'])) { ?>
						<li class="not_current"><a href="./dose_read_mode.php?option=Edit&&group=<?php echo $_GET['group']; ?>&&drug_name=<?php echo $_GET['drug_name']; ?>">Dose</a></li>
					<?php } else { ?>
						<li class="not_current"><a href="./dose_read_mode.php?group=<?php echo $_GET['group']; ?>">Dose</a></li>
					<?php } ?>
				<?php } ?>
              </ul>
            </div>
			...
			<form id="insert_form" action="./insert_general_note.php" method="POST" role="form">
              <div class="panel panel-default general_note">
				<div class="panel-body add-dosis">
                    ...
                    <?php if (isset($_GET['group']) && isset($_GET['drug_name'])) {
						  ...
						  if (isset($_GET['option']) && !strcmp($_GET['option'], "Edit")) {
							...
							<?php
								...
								$addFirstTime = 1; ?>
								<div id="show_notes">
									<textarea disabled id="1" name="add_general_note" rows="4" cols="80" placeholder="Contraindications and cautions, interactions, adverse reactions and toxic reactions (250 characters maximum)"></textarea> 
								</div>
								</div>
                  ...
                  <input disabled type="hidden" name="group_name" value="<?php echo $group_name; ?>"/>
