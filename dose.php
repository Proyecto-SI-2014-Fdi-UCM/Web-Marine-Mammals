						...
						<div class="row">
						  <div class="form-group">
							...
							<div class="inner-panel">
							  ...
							  <div class="col-md-8">
								<div class="input-group">
								  <input type="text" class="form-control" name="animal" id="animal" placeholder="Animal"/>
								  <span class="input-group-btn">
							...
							<div class="inner-panel">
							  ...
							  <div class="col-md-4">
								<div class="input-group">
								  ...
								  <input type="text" class="form-control" name="amount" id="amount" placeholder="Amount (mg/kg)"/>
								  <span class="input-group-btn">
							  ...
							  <div class="col-md-4">
								<div class="input-group">
								  ...
								  <input type="text" class="form-control" name="posology" id="posology" placeholder="SID, BID, TID"/>
								  <span class="input-group-btn">
							  ...
							  <div class="col-md-4">
								<div class="input-group">
								  <input type="text" class="form-control" name="route" id="route" placeholder="PO, IM, IV"/>
								  <span class="input-group-btn">
						...
						<div class="row">                        
						  <div class="form-group">
							...
							<div class="inner-panel">
							  ...
							  <div class="col-md-4">
								<div class="input-group">
								  <input type="text" class="form-control" name="reference" id="reference" placeholder="Book"/>
								  <span class="input-group-btn">
							  ...
							  <div class="col-md-8">
								<div class="input-group">
								  ...
								  <input type="text" class="form-control" name="article-reference" id="article_reference" placeholder="Article"/>
								  <span class="input-group-btn">
